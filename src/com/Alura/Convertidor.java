...
public class Convertidor {
	...
	private static void convertirMoneda() {
		...
		do {
			...
			if (esValido) {
				String[] opciones2 = { "De Peso Colombiano a Dolar", "De Peso Colombiano a Euro",
						"De Peso Colombiano a Libra Esterlina", "De Peso Colombiano a Yen Japones",
						"De Peso Colombiano a Won Sur Coreano", "De Dolar a Peso Colombiano", 
						"De Euro a Peso Colombiano", "De Libra Esterlina a Peso Colombiano", 
						"De Yen Japones a Peso Colombiano", "De Won Sur Coreano a Peso Colombiano" };
